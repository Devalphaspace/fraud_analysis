"""
Django settings for fraud_analysis project.
...
SECRET_KEY = 'django-insecure-7+pc0fd!jo9v2g(m$1#+xw**nqcq%$#a5u9dr!5@p!iv6_^tew'
...
INSTALLED_APPS = [
    ...
    'data_forgery.apps.DataForgeryConfig',
]
...
ROOT_URLCONF = 'fraud_analysis.urls'
...
WSGI_APPLICATION = 'fraud_analysis.wsgi.application'
